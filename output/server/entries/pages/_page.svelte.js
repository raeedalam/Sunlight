...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<footer data-svelte-h="svelte-1ms9sky"><a href="https://discord.gg/goabyss" target="_blank">Discord</a> <a href="https://github.com/Abyss-Services" target="_blank">GitHub</a> <a href="https://intoabyss.org/apply" target="_blank">Apply for Staff</a> <p>Copyright Sunlight Services 2023</p></footer>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div id="settings-temp" style="overflow:auto;display: none;" class="extFrame"><center style="overflow:auto"><h1 class="settingsHeader" data-svelte-h="svelte-14vw6gi">Settings</h1> <h4 data-svelte-h="svelte-cqx8bq">Make sure to test your panic hotkeys. Settings do save.</h4> <br> <br> <div class="settingCards"><div class="abyssCard"><h1 data-svelte-h="svelte-175k23d">Theme</h1> <br> <h2 data-svelte-h="svelte-1ctlc6d">Select from a list:</h2> <div class="settingCardButtons"><select id="themeSelect" onchange="themeSwitch(this)"><option value="Abyss Default" data-svelte-h="svelte-1eqsxxh">Default (Dark Abyss)</option></select></div></div> <div class="abyssCard" data-svelte-h="svelte-rlc9rr"><h1>Tab Customize</h1> <h2>Tab Title</h2> <input type="text" placeholder="Enter Text" onchange="cloakTitle(this.value)"> <br> <h2>Tab Icon</h2> <input type="text" placeholder="Enter URL" onchange="cloakFavicon(this.value)"></div> <div class="abyssCard" data-svelte-h="svelte-1n9lo1x"><h1>Panic Keys</h1> <h2>Panic Keybind</h2> <input type="text" readonly placeholder="Enter key" onclick="recordKeys(this, 500)"> <br> <h2>Panic Key URL</h2> <input type="text" placeholder="Enter URL (defaults to Google)" onchange="cloakURL(this.value)"></div></div></center></div> <div id="games-temp" style="display: none;" class="extFrame" data-svelte-h="svelte-krm8cl"><div class="gameCategoryButtons"></div> <div class="gameCategories"></div></div> <div id="invalid-temp" style="display: none;" class="extFrame" data-svelte-h="svelte-fyklvi"><center><br> <br> <br> <h1>This is an invalid Abyss route, please create a new tab and continue searching.</h1></center></div> ${$$result.head += `<!-- HEAD_svelte-1i3zh95_START --><style data-svelte-h="svelte-17qp8zr">@font-face {
			font-family: 'Roboto';
			font-style: normal;
			font-weight: 300;
			font-display: swap;
